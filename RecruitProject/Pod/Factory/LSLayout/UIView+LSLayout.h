...
-(void (^)(CGFloat x ,CGFloat y) )originBy;
//设置宽高
-(void (^)(CGFloat with ,CGFloat heigh) )sizeBy;
...
//靠近父控件上部
-(void (^)(CGFloat top ,CGFloat left ,CGFloat right,CGFloat with) )edgeNearTop;
//靠近父控件下部
-(void (^)(CGFloat bottom ,CGFloat left ,CGFloat right,CGFloat with) )edgeNearbottom;
